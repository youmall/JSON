# Author: Youri Malleck-Ahmed
# https://www.linkedin.com/in/yourimalleckahmed
# Jun 2022

# Defines a simple "Add" function that builds a JSON-formatted string from a name-value pair, with no
# dependency on any external library, or on support for a Dictionary Object.
# The logic is meant to be implemented in legacy languages with no support for hierachical data structures.
